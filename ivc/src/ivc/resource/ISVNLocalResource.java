...
public interface ISVNLocalResource extends ISVNResource, IAdaptable {
	 ...
	 * @throws IVCException
	 */
	public LocalResourceStatus getStatus() throws Exception;
	 ...
	 * @throws IVCException
	 */
	public SVNRevision getRevision() throws IVCException;
	
	/**
	 * refresh the status of the resource (which is cached)
	 * @throws IVCException
	 */
	public void refreshStatus() throws IVCException;
	 ...
	 * @throws IVCException
	 */
	public boolean isManaged() throws IVCException;

	/**
	 * @return true if this resource is locally added by SVN
	 * @throws IVCException
	 */
	public boolean isAdded() throws IVCException;
	 ...
	 * @throws IVCException
	 */
	public boolean hasRemote() throws IVCException;
	 ...
	 * @throws IVCException
     */    
    public boolean isDirty() throws IVCException;
	 ...
	 * @throws IVCException
	 */
	public void setIgnored() throws IVCException;
	 ...
	 * @throws IVCException
	 */
	public boolean isIgnored() throws IVCException;

	/**
	 * Remove file or directory from version control.
	 * @throws IVCException
	 */
	public void delete() throws IVCException;

	/**
	 * Restore pristine working copy file (undo all local edits)
	 * @throws IVCException
	 */
	public void revert() throws IVCException;
	 ...
	 * @throws IVCException
	 */
	public void resolve() throws IVCException;
