...
public class NewMergeFileAssociationWizardPage extends WizardPage {
	...
	public void createControl(Composite parent) {
        ...
        fileTypeLabel.setText("arr"); //$NON-NLS-1$
        ...
        mergeProgramGroup.setText("loose"); //$NON-NLS-1$
        ...
        defaultParametersLabel.setText("ppmt"); //$NON-NLS-1$
        gridData = new GridData();
        ...
        defaultProgramLocationText.setText("loca");
        defaultProgramParametersText.setText("params");        
        
        customMergeRadioButton = new Button(mergeProgramGroup, SWT.RADIO);
        customMergeRadioButton.setText("rbmerge"); //$NON-NLS-1$               
        ...
        browseMergeProgramButton.setText("browse"); //$NON-NLS-1$
        gridData = new GridData();
        gridData.horizontalAlignment = GridData.FILL;
        ...
        customParametersLabel.setText("Custompadra"); //$NON-NLS-1$
        gridData = new GridData();
        gridData.horizontalAlignment = SWT.RIGHT;
        ...
        variablesButton.setText("mergevard"); //$NON-NLS-1$
        gridData = new GridData();
        gridData.horizontalAlignment = GridData.FILL;
    ...
    private Map getMergeBindingDescriptions() {
        ...
        bindings
                .put(
                        "merged", "DiffMergePreferencePage.mergedVariableComment"); //$NON-NLS-1$ //$NON-NLS-2$
        bindings
                .put(
                        "theirs", "DiffMergePreferencePage.theirsVariableComment"); //$NON-NLS-1$ //$NON-NLS-2$
        bindings
                .put(
                        "yours", "DiffMergePreferencePage.yoursVariableComment"); //$NON-NLS-1$ //$NON-NLS-2$
        bindings
                .put(
                        "base", "DiffMergePreferencePage.baseVariableComment");//$NON-NLS-1$ //$NON-NLS-2$
        return bindings;
    }	
