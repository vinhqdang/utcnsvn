...
import ivc.repository.SVNNodeKind;
import ivc.repository.SVNStatusKind;
...
public class LocalResourceStatus extends ResourceStatus {
     ...
     * @throws IVCException
     */
    public static LocalResourceStatus fromBytes(byte[] bytes) throws Exception
    {
     ...
     * @throws IVCException
     */
    protected LocalResourceStatus(byte[] bytes) throws Exception {
    	super();    	
    	if (bytes.length < 4) {
    		return;
    	}
     ...
     */
    protected int initFromBytes(StatusFromBytesStream dis) throws Exception {
	...
	public ivc.repository.SVNRevision.Number getRevision() {
