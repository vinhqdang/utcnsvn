 ...
 * 
 */
public class ResourceEditionNode implements ITypedElement,
		IStreamContentAccessor, IEncodedStreamContentAccessor,IDiffContainer {
	...
	public InputStream getContents() throws CoreException {
		...
		try {
			...
			IVCPlugin.plugin.runWithProgress(null, true,
